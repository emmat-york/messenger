...
import { selectInput, selectIsLoading, selectMessages, selectSelectedDialog } from './chat.feature';
import * as action from './chat.action';
import { Dialog, EssentialUserData } from '../../shared/services/api/chat/chat-service.interface';
...
export class ChatFacade extends BaseStoreExtension {
  readonly selectedDialog$: Observable<Dialog | EssentialUserData | null> = this.store.select(selectSelectedDialog);
